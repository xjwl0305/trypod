...
exports.branchAdd = (req, res) => {
    ...
    managementDB.branchAdd(uid, branch_name, branch_address, branch_detailed_address, manager_name, manager_phone, manager_email).then(result =>
        res.status(200).json(
            {
                result
            })
...
exports.layerAdd = (req, res) => {
    ...
    managementDB.layerAdd(uid, branch_name, branch_address, branch_detailed_address, layer_name, manager_name, manager_phone, manager_email, min_temp, max_temp).then(result =>
        res.status(200).json(
            {
                result
            })
